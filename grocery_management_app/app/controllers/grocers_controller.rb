class GrocersController < ApplicationController
  before_action :set_grocer, only: [:show, :edit, :update, :destroy, :show_exisiting_order]
  before_action :set_items, only: [:show, :show_exisiting_order]
